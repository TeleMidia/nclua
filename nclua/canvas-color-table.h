...
typedef struct _canvas_color_table_t
{
  ...
  unsigned char g;
  unsigned char b;
} canvas_color_table_t;

static const canvas_color_table_t canvas_color_table[] = {
...
canvas_color_table_compar (const void *e1, const void *e2)
{
  ...
  const canvas_color_table_t *c2;

  c1 = (const canvas_color_table_t *) e1;
  c2 = (const canvas_color_table_t *) e2;
...
static int
canvas_color_table_index (const char *name, double *r, double *g, double *b)
{
  canvas_color_table_t key;
  canvas_color_table_t *match;
